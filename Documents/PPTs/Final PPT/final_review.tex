...
\begin{itemize}
\item RGB images captured using mobile camera.
\item Indoor and outdoor scenes used for testing.
\item Pretrained depth estimation models trained on large public datasets such as:
\begin{itemize}
\item NYU Depth Dataset
\item KITTI Dataset
\end{itemize}
\end{itemize}
\end{frame}
